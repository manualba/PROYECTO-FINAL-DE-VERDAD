...
public class Visualizacion extends JFrame {
	...
	public Visualizacion() {
		...
		scrollBar.setBounds(699, 69, 17, 305);
		panel.add(scrollBar);
		...
		txtrDni.setText("DNI");
		txtrDni.setBounds(127, 46, 52, 23);
		panel.add(txtrDni);
		...
		txtrSexo.setBounds(245, 46, 60, 27);
		panel.add(txtrSexo);
		...
		txtrCuerpo.setBounds(364, 46, 52, 23);
		...
		txtrRango.setBounds(482, 46, 46, 23);
		panel.add(txtrRango);
		...
		txtrDisponibilidad.setBounds(600, 46, 52, 23);
